...
3. **Curation workflow:** ask for 1.5–2× the target count, call `am_resolve_candidates`, compare the
   grounded candidates in natural language, assign narrative roles, and dry-run the final list.
...
recording. Audio-feature coverage must appear beside any flow result because unmeasured positions
were not evaluated.
