...
the project maintainer through [GitHub private reporting](https://github.com/Z-Han-Z/apple-music-playlists/security/advisories/new).
Start the report title with `Code of Conduct:` so it can be routed correctly. Do not file a public
issue or include another person's private information in public.

All complaints will be reviewed and investigated promptly and fairly. The maintainer will respect
the privacy and security of the reporter. If the maintainer is involved in the reported incident,
GitHub's platform-level [reporting tools](https://support.github.com/contact/report-abuse) should
be used instead.
